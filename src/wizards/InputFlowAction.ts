...
export class MultiStepInput {
  ...
  async showQuickPick<T extends QuickPickItem, P extends QuickPickParameters<T>>({ title, step, totalSteps, items, activeItem, placeholder, buttons, shouldResume, canSelectMany }: P) {
    ...
    try {
      return await new Promise<T | (P extends { buttons: (infer I)[] } ? I : never)>((resolve, reject) => {
        ...
        disposables.push(
          ...
          canSelectMany?input.onDidAccept(() => {
